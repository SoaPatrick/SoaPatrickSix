		    ...
		    <header class="site-header">
			    ...
			    <div class="container">		
					<a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home" class="logo">	
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 269.24 234.03" class="logo">
							<path class="logo--letter-s" d="M60.21,179H1.81c-1.55,0-2.11-.67-1.66-2l12.92-42.09L98.24.72A1.9,1.9,0,0,1,99.57.06h54.68c1.54,0,2.1.66,1.66,2L116.14,134h11.93c1.54,0,2.1.66,1.66,2L116.8,177.69c-.45.89-1,1.33-1.66,1.33H102.22L86.31,232.7c-.44.88-1,1.33-1.66,1.33H46.21c-1.55,0-2.1-.67-1.65-2M95.92,60.38l-44.4,74.89h21.8"/>
							<path class="logo--letter-s" d="M178.37,190.07c2.11-1,4.36-6.5,6.94-14.47L220.82,58.1a30.88,30.88,0,0,0,1.93-9q0-5.81-5.16-5.81c-2.58,0-5.06,1.25-7.43,3.72s-4.41,6.51-6.13,12.1v-.32l-35.51,117.5a44.45,44.45,0,0,0-1.61,8.71c0,2.47.3,3.55,1.77,4.84a4.45,4.45,0,0,0,1.57.89A11.12,11.12,0,0,0,178.37,190.07Zm-22.11,44q-17.43-.66-26.63-7.59t-9.2-21.79q0-9.36,3.87-21.62v.32l40-133q8.05-27.12,24.21-38.74T229.53,0q19.36,0,29.54,6.78T269.24,29.7q0,8.72-3.55,21.3l-40,133q-8.07,25.83-22.76,37.45T165,234Z"/>
						</svg>											
<!--
