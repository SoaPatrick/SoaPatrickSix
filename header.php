...
<body <?php body_class(); ?>>
	...
	<div id="search-collapse">
		<div class="container">
			<form class="grid search-form" action="<?php echo home_url( '/' ); ?>" method="get">
				...
				<label for="search-collapse--input">Search</label>
			</form>
		</div>
	</div>
	...
	<nav class="site-navigation">
		...
		<a class="site-navigation__link" href="<?php echo esc_url( home_url( '/' ) ); ?>storage"><span>Storage</span><i class="fal fa-archive"></i></a>
		<a class="site-navigation__link" href="<?php echo esc_url( home_url( '/' ) ); ?>factory"><span>Factory</span><i class="fal fa-industry"></i></a>
		<span class="site-navigation__link" id="toggle-settings"><span>Settings</span><i class="fal fa-sliders-v"></i></span>
		<spam class="site-navigation__link" id="toggle-search-collapse"><span>Find stuff</span><i class="fal fa-search"></i></span>
	</nav>
	<div class="wrapper">
		<?php if ( is_home() && !is_paged() ) : ?>
		    <header class="site-header">
				...
				<div class="container">
					<a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home" class="logo" alt="SoaPatrick">
